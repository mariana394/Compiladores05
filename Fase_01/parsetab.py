...
_lr_productions = [
  ...
  ('end_assign -> SEMICOLON empty','end_assign',2,'p_end_assign','parser.py',268),
  ('condition -> IF LPAREN exp RPAREN body condition2 SEMICOLON','condition',7,'p_condition','parser.py',280),
  ('condition2 -> ELSE body','condition2',2,'p_condition2','parser.py',283),
  ('condition2 -> empty','condition2',1,'p_condition2','parser.py',284),
  ('print -> PRINT LPAREN print_many RPAREN SEMICOLON','print',5,'p_print','parser.py',288),
  ('print_type -> exp','print_type',1,'p_print_type','parser.py',292),
  ('print_many -> print_type print_many2','print_many',2,'p_print_many','parser.py',295),
  ('print_many2 -> COMMA print_many','print_many2',2,'p_print_many2','parser.py',298),
  ('print_many2 -> empty','print_many2',1,'p_print_many2','parser.py',299),
  ('read -> READ LPAREN variable RPAREN','read',4,'p_read','parser.py',305),
  ('cycle -> for','cycle',1,'p_cycle','parser.py',309),
  ('cycle -> while','cycle',1,'p_cycle','parser.py',310),
  ('while -> DO body WHILE LPAREN exp RPAREN SEMICOLON','while',7,'p_while','parser.py',314),
  ('for -> FOR LPAREN ID TO for_end RPAREN body SEMICOLON','for',8,'p_for','parser.py',318),
  ('for_end -> int_const_saver','for_end',1,'p_for_end','parser.py',321),
  ('for_end -> ID','for_end',1,'p_for_end','parser.py',322),
  ('call_function -> function_saver LPAREN exp exp_many RPAREN','call_function',5,'p_call_function','parser.py',327),
  ('function_saver -> ID empty','function_saver',2,'p_function_saver','parser.py',332),
  ('exp_many -> COMMA exp exp_many','exp_many',3,'p_exp_many','parser.py',339),
  ('exp_many -> empty','exp_many',1,'p_exp_many','parser.py',340),
  ('statement -> assign','statement',1,'p_statement','parser.py',344),
  ('statement -> condition','statement',1,'p_statement','parser.py',345),
  ('statement -> print','statement',1,'p_statement','parser.py',346),
  ('statement -> cycle','statement',1,'p_statement','parser.py',347),
  ('statement -> call_function','statement',1,'p_statement','parser.py',348),
  ('special_function -> exploration','special_function',1,'p_special_function','parser.py',352),
  ('special_function -> financial_state','special_function',1,'p_special_function','parser.py',353),
  ('special_function -> dummi_regression','special_function',1,'p_special_function','parser.py',354),
  ('special_function -> season_analysis','special_function',1,'p_special_function','parser.py',355),
  ('special_function -> trend_prediction','special_function',1,'p_special_function','parser.py',356),
  ('special_function -> model_predict','special_function',1,'p_special_function','parser.py',357),
  ('exploration -> EXPLORATION LPAREN variable explore_var explor_cte RPAREN','exploration',6,'p_exploration','parser.py',363),
  ('explore_var -> COMMA variable','explore_var',2,'p_explore_var','parser.py',366),
  ('explore_var -> empty','explore_var',1,'p_explore_var','parser.py',367),
  ('explor_cte -> COMMA int_const_saver','explor_cte',2,'p_explor_cte','parser.py',370),
  ('explor_cte -> empty','explor_cte',1,'p_explor_cte','parser.py',371),
  ('financial_state -> FINANCIAL_STATE LPAREN variable COMMA variable COMMA variable COMMA variable RPAREN','financial_state',10,'p_financial_state','parser.py',375),
  ('season_analysis -> SEASON_ANALYSIS LPAREN variable RPAREN','season_analysis',4,'p_season_analysis','parser.py',379),
  ('trend_prediction -> TREND_PREDICTION LPAREN variable COMMA int_const_saver COMMA int_const_saver COMMA int_const_saver RPAREN','trend_prediction',10,'p_trend_prediction','parser.py',385),
  ('dummi_regression -> DUMMI_REGRESSION LPAREN variable COMMA variable dr_array dr_int RPAREN','dummi_regression',8,'p_dummi_regression','parser.py',389),
  ('dr_array -> COMMA LSQBRACKET CTE_CHAR dr_array_mp RSQBRACKET','dr_array',5,'p_dr_array','parser.py',392),
  ('dr_array -> empty','dr_array',1,'p_dr_array','parser.py',393),
  ('dr_array_mp -> COMMA CTE_CHAR dr_array_mp','dr_array_mp',3,'p_dr_array_mp','parser.py',396),
  ('dr_array_mp -> empty','dr_array_mp',1,'p_dr_array_mp','parser.py',397),
  ('dr_int -> COMMA int_const_saver','dr_int',2,'p_dr_int','parser.py',400),
  ('dr_int -> empty','dr_int',1,'p_dr_int','parser.py',401),
  ('model_predict -> MODEL_PREDICT LPAREN variable COMMA variable COMMA RPAREN','model_predict',7,'p_model_predict','parser.py',405),
  ('exp -> t_exp exp_or','exp',2,'p_exp','parser.py',410),
  ('exp_or -> OR exp','exp_or',2,'p_exp_or','parser.py',413),
  ('exp_or -> empty','exp_or',1,'p_exp_or','parser.py',414),
  ('t_exp -> expression t_exp_and','t_exp',2,'p_t_exp','parser.py',418),
  ('t_exp_and -> AND t_exp','t_exp_and',2,'p_t_exp_and','parser.py',421),
  ('t_exp_and -> empty','t_exp_and',1,'p_t_exp_and','parser.py',422),
  ('expression -> m_exp expression_comp','expression',2,'p_expression','parser.py',426),
  ('expression_comp -> expression_comp_2 m_exp','expression_comp',2,'p_expression_comp','parser.py',429),
  ('expression_comp -> empty','expression_comp',1,'p_expression_comp','parser.py',430),
  ('expression_comp_2 -> EQUAL','expression_comp_2',1,'p_expression_comp_2','parser.py',433),
  ('expression_comp_2 -> NOTEQUAL','expression_comp_2',1,'p_expression_comp_2','parser.py',434),
  ('expression_comp_2 -> LTHAN','expression_comp_2',1,'p_expression_comp_2','parser.py',435),
  ('expression_comp_2 -> GTHAN','expression_comp_2',1,'p_expression_comp_2','parser.py',436),
  ('m_exp -> term m_exp_sr','m_exp',2,'p_m_exp','parser.py',441),
  ('m_exp_sr -> m_exp_sr_2 m_exp','m_exp_sr',2,'p_m_exp_sr','parser.py',445),
  ('m_exp_sr -> empty','m_exp_sr',1,'p_m_exp_sr','parser.py',446),
  ('m_exp_sr_2 -> PLUS','m_exp_sr_2',1,'p_m_exp_sr_2','parser.py',449),
  ('m_exp_sr_2 -> MINUS','m_exp_sr_2',1,'p_m_exp_sr_2','parser.py',450),
  ('term -> sub_factor term_pc','term',2,'p_term','parser.py',456),
  ('term_pc -> term_pc_2 term','term_pc',2,'p_term_pc','parser.py',459),
  ('term_pc -> empty','term_pc',1,'p_term_pc','parser.py',460),
  ('term_pc_2 -> MULTIPLY','term_pc_2',1,'p_term_pc_2','parser.py',463),
  ('term_pc_2 -> DIVIDE','term_pc_2',1,'p_term_pc_2','parser.py',464),
  ('term_pc_2 -> MODULE','term_pc_2',1,'p_term_pc_2','parser.py',465),
  ('sub_factor -> factor sub_factor_pc','sub_factor',2,'p_sub_factor','parser.py',470),
  ('sub_factor_pc -> sub_factor_pc_2 sub_factor','sub_factor_pc',2,'p_sub_factor_pc','parser.py',473),
  ('sub_factor_pc -> empty','sub_factor_pc',1,'p_sub_factor_pc','parser.py',474),
  ('sub_factor_pc_2 -> POWER empty','sub_factor_pc_2',2,'p_sub_factor_pc_2','parser.py',477),
  ('factor -> factor_exp','factor',1,'p_factor','parser.py',483),
  ('factor -> factor_cte','factor',1,'p_factor','parser.py',484),
  ('factor -> variable','factor',1,'p_factor','parser.py',485),
  ('factor -> call_function','factor',1,'p_factor','parser.py',486),
  ('factor_exp -> LPAREN exp RPAREN','factor_exp',3,'p_factor_exp','parser.py',489),
  ('factor_cte -> CTE_FLOAT','factor_cte',1,'p_factor_cte','parser.py',492),
  ('factor_cte -> CTE_INT','factor_cte',1,'p_factor_cte','parser.py',493),
  ('factor_cte -> CTE_CHAR','factor_cte',1,'p_factor_cte','parser.py',494),
]
